...
class Http
{
    ...
    {
        // Init.
        $_HEADER = $_POST = $_GET = $_COOKIE = $_SESSION = $_FILES = array();
        ...
        $_SERVER['PHP_URL_PATH'] = parse_url($_SERVER['REQUEST_URI'], PHP_URL_PATH);
        ...
        $GLOBALS['header'] =  $_HEADER;
        return array('header' => $_HEADER, 'get' => $_GET, 'post' => $_POST, 'cookie' => $_COOKIE, 'server' => $_SERVER, 'files' => $_FILES);
    }
